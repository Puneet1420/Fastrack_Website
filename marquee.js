// Marquee.js is a jQuery plugin that animates a marquee element.
...
function horizontalLoop(items, config) {
    ...
    const boxes = gsap.utils.toArray(".beboth");
    loop = horizontalLoop(boxes, {paused: false , repeat:-1,speed:1});

// y Axis-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
gsap.registerPlugin(ScrollTrigger, ScrollSmoother);

verticalLoop(".slide-text-up", {
  repeat: -1,
  speed: 0.5
});
...
function horizontalLoop(items, config) {
    ...
    const box = gsap.utils.toArray(".bebothm");
    loop = horizontalLoop(box, {paused: false , repeat:-1,speed:1});

// y Axis-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
gsap.registerPlugin(ScrollTrigger, ScrollSmoother);

verticalLoop(".slide-text-upm", {
  repeat: -1,
  speed: 0.5
});

verticalLoop(".slide-text-downm", {
  repeat: -1,
  speed: 0.5,
  reversed: true
});
